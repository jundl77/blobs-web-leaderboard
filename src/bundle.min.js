...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Background = __webpack_require__(159);

	var _Background2 = _interopRequireDefault(_Background);

	var _GameIDTextField = __webpack_require__(164);

	var _GameIDTextField2 = _interopRequireDefault(_GameIDTextField);

	var _LeaderboardTable = __webpack_require__(161);

	var _LeaderboardTable2 = _interopRequireDefault(_LeaderboardTable);
	...
	var Layout = _react2.default.createClass({
	    ...
	    handleUserInput: function handleUserInput(gameId) {
	        this.setState({
	            gameId: gameId
	        });
	    },
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                "div",
	                { className: "title" },
	                "Blobs World Wide Leaderboard"
	            ),
	            _react2.default.createElement(_GameIDTextField2.default, { gameId: this.state.gameId, onUserInput: this.handleUserInput }),
	            _react2.default.createElement(_LeaderboardTable2.default, { rankings: rankings, gameId: this.state.gameId }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ENV_VARS = __webpack_require__(160);

	var _ENV_VARS2 = _interopRequireDefault(_ENV_VARS);
	...
	var Background = function Background() {
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement("img", { src: _ENV_VARS2.default.BG_IMG_PATH })
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LeaderboardRow = __webpack_require__(162);
	...
	var LeaderboardTable = function (_React$Component) {
	    ...
	    function LeaderboardTable() {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(LeaderboardTable).call(this));

	        _this.state = {
	            rankings: []
	        };

	        updateRankings = _this;
	        return _this;
	    }
	    ...
	    _createClass(LeaderboardTable, [{
	            ...
	            function fetchRankings(reactComponent) {
	                ...
	                function updateRankings(jsonRankings) {
	                    ...
	                    for (var key in jsonRankings) {
	                        rankings.push(new Ranking(jsonRankings[key].Name, jsonRankings[key].Score, jsonRankings[key].game_id));
	                    }
	                ...
	                _jquery2.default.ajax({
	                    url: _ENV_VARS2.default.DATA_URL,
	                    type: 'GET',
	                    dataType: 'html',
	        ...
	        value: function render() {
	            var entries = [];
	            this.state.rankings.sort(function (ranking1, ranking2) {
	            ...
	            this.state.rankings.forEach(function (ranking) {
	                if (this.props.gameId === null || this.props.gameId === '' || this.props.gameId === ranking.gameId + '') {
	                    entries.push(_react2.default.createElement(_LeaderboardRow2.default, { score: ranking.score, name: ranking.name }));
	                }
	            }.bind(this));
	...
	var Ranking = function Ranking(name, score, gameId) {
	    this.name = name;
	    this.score = score;
	    this.gameId = gameId;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LeaderboardRow = _react2.default.createClass({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameIDTextField = _react2.default.createClass({
	    displayName: "GameIDTextField",

	    handleChange: function handleChange() {
	        this.props.onUserInput(this.refs.gameIdInput.value);
	    },

	    render: function render() {
	        return _react2.default.createElement(
	            "div",
	            { className: "gameIdtextFieldDiv" },
	            _react2.default.createElement("input", { className: "gameIdtextField",
	                type: "text",
	                placeholder: "Game ID",
	...
	exports.default = GameIDTextField;
