...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.setRankings = setRankings;
	...
	var _LeaderboardTable = __webpack_require__(162);
	...
	function setRankings(rankingsLocal) {
	    console.log("set");
	...
	var Layout = function Layout() {
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_LeaderboardTable2.default, { rankings: rankings }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ENV_VARS = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LeaderboardRow = __webpack_require__(163);
	        ...
	        value: function componentWillMount() {
	            ...
	            function fetchRankings() {
	                ...
	                _jquery2.default.ajax({
	                    url: 'http://query.yahooapis.com/v1/public/yql?q=select * from html where url="' + _ENV_VARS2.default.DATA_URL + '"&format=json',
	                    type: 'GET',
	                    dataType: 'html',
	                    success: function success(response) {
	                        var jsonResponse = JSON.parse(response);
	                        var data = JSON.parse(jsonResponse.query.results.body);
	                        parseRankings(data);
	                    },
